...
const en: Content = {
  ...
  authModal: {
    ...
    formPlaceholderConfirmPassword: 'Confirm Password',
    ...
    // FIX: Added missing properties to satisfy the AuthModalContent type.
    currentUser: null,
    intent: 'auth',
  },
  commercialOffer: {
  ...
  adminDashboard: {
    ...
    roleAdmin: 'Admin',
    roleUser: 'User',
    loginAsButton: 'Login As',
    loggingIn: '...',
  },
  impersonationBanner: {
    message: "You are viewing as {{name}}.",
    returnButton: "Return to Admin",
  },
...
const ar: Content = {
    ...
    authModal: {
        ...
        formPlaceholderPassword: 'كلمة المرور',
        formPlaceholderConfirmPassword: 'تأكيد كلمة المرور',
    ...
    adminDashboard: {
        ...
        roleAdmin: 'مسؤول',
        roleUser: 'مستخدم',
        loginAsButton: 'تسجيل الدخول كـ',
        loggingIn: '...',
    },
    impersonationBanner: {
        message: "أنت تتصفح الآن كـ {{name}}.",
        returnButton: "العودة إلى حساب المسؤول",
    },
...
const de: Content = {
  ...
  authModal: {
    ...
    formPlaceholderName: 'Vollständiger Name',
    formPlaceholderEmail: 'E-Mail-Adresse',
    formPlaceholderPassword: 'Passwort',
    formPlaceholderConfirmPassword: 'Passwort bestätigen',
  ...
  adminDashboard: {
    ...
    roleAdmin: 'Admin',
    roleUser: 'Benutzer',
    loginAsButton: 'Anmelden als',
    loggingIn: '...',
  },
  impersonationBanner: {
    message: "Sie sehen die Seite als {{name}}.",
    returnButton: "Zurück zum Admin",
  },
...
const es: Content = {
  ...
  adminDashboard: {
    ...
    roleAdmin: 'Admin',
    roleUser: 'Usuario',
    loginAsButton: 'Iniciar Sesión Como',
    loggingIn: '...',
  },
  impersonationBanner: {
    message: "Estás viendo como {{name}}.",
    returnButton: "Volver a Admin",
  },
